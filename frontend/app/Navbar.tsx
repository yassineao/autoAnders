        ...
        >
            ...
            {content.items.map((item) => (
              <li key={item.href} className="group relative">
                <Link
                  ...
                  className="inline-flex h-10 items-center gap-1 rounded-lg px-4 text-sm font-medium text-brand-muted transition-colors hover:bg-white/5 hover:text-white"
                >
                  {item.label}
                      ...
                      {item.children.map((child) => (
                        <li key={child.href}>
                          <Link
                            ...
                            className="block rounded-lg px-3 py-2.5 text-sm text-brand-muted transition-colors hover:bg-white/8 hover:text-white"
                          >
                            {child.label}
                          </Link>
                        </li>
          ...
          <div className="hidden items-center gap-3 lg:flex">
            ...
            <LocaleSwitchLink
              ...
              className="inline-flex h-10 items-center rounded-lg px-4 text-sm font-medium text-brand-muted transition-colors hover:bg-white/5 hover:text-white"
            />
