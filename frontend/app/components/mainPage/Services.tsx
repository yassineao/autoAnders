...
export default function Services({
    ...
    return (
        <div
            id="services"
            className="flex flex-1 flex-col items-center justify-center overflow-hidden bg-black py-10 sm:py-14 lg:py-20"
        >
            <section
                id="services-list"
                ...
                <div className="mx-auto w-full px-4 sm:px-6 lg:px-8">
                    <div className="">
                        <div>
                            ...
                            <h2
                                id="services-heading"
                                className="mt-3  text-3xl font-black leading-[1.05] text-white sm:text-4xl lg:text-5xl"
                            >
                                {content.title}
                            </h2>
                        </div>

                        <p className="mt-10 text-sm leading-6 text-zinc-400 sm:text-base sm:leading-8 lg:ml-auto lg:text-lg">
                            {content.description}
                        </p>
                    </div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="relative flex gap-4">
                                        <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl border border-red-500/30 bg-red-600/10">
                                            <Image
                                                src={art.src}
                                                alt={art.alt}
                                                className="h-auto w-8 object-contain invert"
                                                width={64}
                                                height={64}
                                                loading="lazy"
                                            />
                            ...
                            return (
                                ...
                                >
                                    <div className="relative flex h-56 w-full items-center justify-center overflow-hidden">
                                        <div className="absolute inset-0 bg-gradient-to-br from-red-600/20 via-black to-white/10 transition-opacity duration-300 group-hover:opacity-90" />
                                        <div className="absolute -right-12 -top-12 h-36 w-36 rounded-full bg-red-600/20 blur-3xl transition-transform duration-500 group-hover:scale-125" />
                                        <div className="absolute inset-x-6 top-0 h-px bg-gradient-to-r from-transparent via-red-500/70 to-transparent" />

                                        <Image
                                            src={art.src}
                                            alt={art.alt}
                                            className="relative z-10 h-auto w-40 max-w-[70%] object-contain invert transition duration-300 group-hover:scale-105"
                                            width={144}
                                            height={144}
                                            loading="lazy"
                                        />
